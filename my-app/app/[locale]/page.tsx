    ...
    <div className="flex min-h-[100dvh] flex-col bg-white">
      ...
      >
        ...
        <nav className="flex flex-col px-6">
          {[
            { id: "help-center", label: t.common.helpCenter, href: "#" },
            { id: "contact-us", label: t.common.contactUs, href: "#" },
            { id: "terms", label: t.common.terms, href: "#" },
            { id: "privacy-policy", label: t.common.privacyPolicy, href: "#" },
            { id: "cookie-policy", label: t.common.cookiePolicy, href: "#" },
            { id: "privacy-settings", label: t.common.privacySettings, href: "#" },
          ].map((link) => (
            <a
              key={link.id}
              href={link.href}
